...
gui = init(); 
if (gui.cancelled == 1); return; end

%% Configuration of the Dataset
%DatasetConfig_manually % Manually dataset definition
DatasetConfig_gui % Dataset definition by the GUI
...
fprintf('\nFinal Results:\n -Training error: %d\n -Testing error: %d\n', error_train, error_test); % just to print

% final GUI, final results are presented, and also estimated output and MF's plots
finish(error_train,error_test,x,y_train,data_ytrain,y_test,data_ytest);
